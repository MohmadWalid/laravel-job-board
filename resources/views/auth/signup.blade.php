        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action="{{ route('signup') }}" method="POST">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="text" name="name" id="name" autocomplete="name" placeholder="Eg. Walid"
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="email" name="email" id="email" autocomplete="email"
                            value="{{ old('email') }}" placeholder="Eg. emailforexample@email.com" required
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="password" name="password_confirmation" id="password_confirmation"
                            ...
                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 border {{ $errors->has('password_confirmation') ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-indigo-600' }} focus:outline-none focus:ring-2 focus:ring-offset-2 placeholder:text-gray-400 sm:text-sm" />
            ...
            <p class="mt-10 text-center text-sm/6 text-gray-500">
                ...
                <a href="{{ route('showLoginForm') }}" class="font-semibold text-indigo-600 hover:text-indigo-500">Log
                    in</a>
            </p>
        </div>
    </div>
